...
test = c(0.12259058,0.24403446,0.19607871,0.11951997,0.09190809,0.0542,0.01998301,0.01938363,0.02142687,0.02774591)
logit <- function(x){log(x/(1-x))}
ascertainment = c(0.17,0.11,0.13,0.14,0.16,0.32,0.48, 0.57, 0.60, 0.55)
#ascertainment_low = c(0.1,0.05,0.05,0.06,0.12,0.12,0.14,0.12,0.12,0.1)
#ascertainment_high = c(0.23,0.24,0.29,0.43,0.75,0.84,0.9,0.94,0.96,0.97)
